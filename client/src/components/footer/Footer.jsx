      ...
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          <p className="text-sm capitalize">
            ...
            content creation with our suite of premium ai tools. write article,
        ...
        <div className="max-w-80">
          ...
          <div className="flex items-center mt-4">
            ...
            />
            <button className="flex items-center justify-center bg-primary cursor-pointer h-9 w-9 aspect-square rounded-r">
              {/* Arrow icon */}
              <svg
