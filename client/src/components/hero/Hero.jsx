...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover min-h-screen bg-no-repeat">
      ...
      {/* button */}
      <div className="capitalize flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={() => navigate("/ai")}
      ...
      <div className="flex items-center gap-4 mt-8 mx-auto text-gray-600">
        <img src={assets.user_group} alt="user_group" className="h-8 " />
        Trusted by 100k+ people(just kidding we just started)
      </div>
    </div>
  );
};
