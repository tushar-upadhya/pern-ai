  ...
  return (
    <div className="h-full capitalize overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
          ...
          {articleLength.map((items, index) => (
            <span
              ...
              className={`text-sm px-4 py-1 border rounded-full cursor-pointer ${
                selectedLength.text === items.text
        ...
        <br />
        <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226bff] to-[#65adff] text-white px-4 py-2 my-6 text-sm rounded-lg cursor-pointer">
          <Edit className="w-5" />
          Generate Article
        </button>
      </form>
